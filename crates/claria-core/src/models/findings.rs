...
/// Quotes carried by a finding — the conflicting passage, the cited record
/// text, and both halves of a style replacement. Deliberately the same ceiling
/// as a drafting citation quote: these are pointers into the document, not
/// copies of it.
...
/// A quote a finding attributes to one of the client's records.
#[derive(Debug, Clone, Serialize, Deserialize, PartialEq, Eq, specta::Type)]
