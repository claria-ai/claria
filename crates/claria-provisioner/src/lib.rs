...
pub use crate::{
    account_setup::{
        ...
        claria_policy_document, create_access_key, delete_root_access_key, delete_user_access_key,
        get_caller_identity, list_user_access_keys, render_policy_document, update_iam_policy,
        validate_new_credentials, validate_teardown_credentials,
    },
    addr::ResourceAddr,
